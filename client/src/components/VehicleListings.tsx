...
export const VehicleListings: React.FC = () => {
  ...
  // Vérifier si on doit afficher la vue avec onglets pour véhicules accidentés
  ...
  // Vue avec onglets pour véhicules accidentés
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="mb-8">
            ...
            <p className="text-gray-600 mt-2">
              Trouvez des véhicules accidentés à réparer ou pour pièces
              détachées
            </p>
          </div>
