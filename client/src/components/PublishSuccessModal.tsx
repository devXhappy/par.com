    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl max-w-md w-full p-8 text-center transform animate-in fade-in zoom-in duration-300">
        ...
        <div className="bg-blue-50 rounded-xl p-4 mb-6">
          ...
          {!isSearch && (
            <p className="text-sm text-blue-700 mt-2 border-t border-blue-100 pt-2">
              Une fois validée, vous pourrez booster votre annonce depuis votre tableau de bord pour augmenter sa visibilité.
            </p>
          )}
        </div>
